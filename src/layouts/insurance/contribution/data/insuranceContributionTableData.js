...
export default function InsuranceContributionTableData() {
  ...
  const handleUpdateInsuranceContribution = (value) => {
    ...
    MySwal.fire({
      ...
      html: ` <table><tr><td>
                 <label for="cash">Cash Payment Amount (NGN)</label></td>
                 <td><input type="text" id="cash" value="${cashx}" class="swal2-input"></td></tr><br>
                 <tr><td>
                 <label for="cash">Card Payment Amount (NGN)</label></td>
                 <td><input type="text" id="card" value="${cardx}" class="swal2-input"></td></tr><br>
                 <tr><td>
                 <label for="cash">Check Payment Amount (NGN)</label></td>
  ...
  return {
    columns: [
      ...
      { Header: "approved by", accessor: "approvedByName", align: "left" },
      {
