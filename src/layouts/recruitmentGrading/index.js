...
import recruitmentGradingDataTable from "layouts/recruitmentGrading/data/recruitmentGradingDataTable";
...
function RecruitmentGrading() {
  ...
  const { columns: pColumns, rows: pRows } = recruitmentGradingDataTable();
  ...
  const handleClick = (e) => {
    ...
    if (enabled) {
      ...
      fetch(`${process.env.REACT_APP_RAGA_URL}//recruitmentGrading/add`, requestOptions)
        .then(async (res) => {
...
export default RecruitmentGrading;
