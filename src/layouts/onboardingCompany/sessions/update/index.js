        ...
        .then((result) => {
          ...
          const raw2 = JSON.stringify([
            {
              ...
              name: storedArray.onboardingDTO.empName,
              email: filteredItemsEmp.personal.email,
              personalID: storedArray.onboardingDTO.empID,
          ...
          fetch(`${process.env.REACT_APP_RAGA_URL}/appointmentParticipant/add`, requestOptions2)
            ...
            .then((resultr) => {
              ...
              fetch(`${process.env.REACT_APP_RAGA_URL}/onboardingSession/update`, requestOptions5)
                .then(async (res) => {
                  const aToken = res.headers.get("token-1");
                  localStorage.setItem("rexxdex", aToken);
                  return res.json();
...
export default UpdateOnboardingSession;
