...
export default function ProductTableData() {
  ...
  const handleBranch = (value) => {
    navigate(`/products/products-Branch?id=${value}`);
  };
  ...
  const handleUpdate = (value) => {
    navigate(`/product/update?id=${value}`);
  };
  ...
  return {
    columns: [
      ...
      { Header: "Price Per Quantity (NGN)", accessor: "pricePerQuantity", align: "left" },
      {
        Header: "Date Created",
          ...
          >
            <Dropdown>
              ...
              <Dropdown.Menu>
                ...
                <Dropdown.Item onClick={() => handleBranch(value)}>Add Branch</Dropdown.Item>
