...
function UpdateBonusOrDeduction() {
  ...
  const [bonusOrDeduction, setBonusOrDeduction] = useState({});
  ...
  const handleClick = (e) => {
    ...
    const raw = JSON.stringify({
      ...
      createdTime: bonusOrDeduction.createdTime,
      deleteFlag: bonusOrDeduction.deleteFlag,
    });
