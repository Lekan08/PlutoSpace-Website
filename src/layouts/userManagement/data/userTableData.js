...
export default function UserData() {
  ...
  const handlePension = (value, tablex) => {
    ...
    navigate(
      `/user-pension-settings?id=${value}&name=${filteredItems[0].personal.fname} ${filteredItems[0].personal.lname}`
    );
  };
  return {
    columns: [
      { Header: "Employee ID", accessor: "personalCompany.personalID", align: "left" },
