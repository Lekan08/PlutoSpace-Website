...
function SingleCorporate() {
  const MySwal = withReactContent(Swal);
  const { columns: pColumns, rows: pRows } = SingleCorporateTable();
  ...
  const handleOnYearOfEstaKeys = () => {
    const numbers = /^[0-9 ]+$/;
    if (!yearOfEstablishmentx.match(numbers)) {
      setCheckedYear(false);
      // eslint-disable-next-line no-unused-expressions
      document.getElementById("year").innerHTML = "Year Of Establishment - input only numbers<br>";
    }
    if (cityx.match(numbers)) {
      setCheckedYear(true);
      // eslint-disable-next-line no-unused-expressions
  ...
  //   //     "Street - input only capital and small letters<br>";
  //   // }
  //   if (streetx.match(letters)) {
  ...
  // const tryagain = handleCheckYear;

  // const handleOnStreet = (e) => {
  //   if (streetx === "") {
  //     ret
  //   }
  // }
  ...
  if (myForm) {
    myForm.addEventListener(handleClick2, (e) => {
      e.preventDefault();
      const input = csvFile.files[0];
      const reader = new FileReader();

      reader.onload = function (v) {
        const text = v.target.result;
        document.write(text);
      };
    ...
    <DashboardLayout>
      ...
      <Accordion defaultActiveKey="0">
        <Accordion.Item eventKey="1">
          <Accordion.Header>Add Corporate</Accordion.Header>
          <Accordion.Body>
            <Paper elevation={3}>
              <br />
                    ...
                    /> */}
                        ...
                        <div className="col-sm-6">
                          <MDInput
                            ...
                            onKeyUp={handleOnYearOfEstaKeys}
      ...
      {/* <Card>
        <MDBox> */}
      {/* {/* <Container> */}
      {/* <MDInput type="file" id="csvFile" accept=".csv" /> */}
      {/* <br /> */}
      {/* <MDInput type="submit" value="Submit" /> */}
      {/* <MDBox mt={4} mb={1}>
              <MDButton variant="gradient" onClick={handleClick2} color="info" width="50%">
                Upload Excel Sheet
              </MDButton>
            </MDBox> */}
      {/* </Container> */}
