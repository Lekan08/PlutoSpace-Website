    ...
    <div>
      <Accordion>
        <Accordion.Item eventKey="2">
          <Accordion.Header>Add Multiple Upload On My Offboarding</Accordion.Header>
          <Accordion.Body>
            <Paper elevation={3}>
        ...
        <Accordion.Item eventKey="3" onClick={() => navigate("/offboarding/multi-sessions")}>
          <Accordion.Header>Add Multiple Offboarding Sessions</Accordion.Header>
        </Accordion.Item>
